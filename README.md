# [ZiftSolutions TSlint](https://www.npmjs.com/package/zift-tslint)
...
You can install **`zift-tslint`** using `npm`
```
npm install zift-tslint --save
```
